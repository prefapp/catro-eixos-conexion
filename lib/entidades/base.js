...
class ConexionBase{
    ...
    constructor({host, puerto, uri_base, protocolo, eventos = {}, headers = {}}){
        ...
        __inicializarEventos({antesPeticion = (r) => r, despuesPeticion = (r) => r}){
    ...
    peticion({url, verbo, args = {}}){
        ...
        this.eventos.antesPeticion({url, args});
        ...
        return new Promise((cumplida, falla) => {
            ...
            request[verbo](opcs, (err, r, body) => {
                ...
                body = this.eventos.despuesPeticion(body);
    ...
    interpolarParametrosUrl(url, parametros){
        ...
        while(p = URL_PARAMETROS.exec(url)){
            ...
            url = url.replace(reg, parametros[nombre_parametro]);
